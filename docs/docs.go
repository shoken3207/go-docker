...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "成功",
                        "schema": {
                            "$ref": "#/definitions/utils.ApiResponse-array_team_TeamListResponse"
                        }
                    },
                    "400": {
                        "description": "リクエストエラー",
    ...
    "definitions": {
        ...
        "utils.ApiResponse-array_team_TeamListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/team.TeamListResponse"
                    }
                },
                "messages": {
                    "type": "array",
